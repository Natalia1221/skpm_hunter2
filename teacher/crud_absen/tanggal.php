			...
			<div class="container mx-auto my-3 mx-2" >
        		<div class="table-responsive col-md-12 my-3 mx-2" style="overflow-x: auto">
					...
					<tr>
					 ...
					 <?php
                        while($user_data = mysqli_fetch_array($data_found)) {         
                            ...
                            echo "<td><a class='btn btn-success' href='crud_absen.php?ID_KELAS=$ID_KELAS&ID_MAPEL=$ID_MAPEL'>Lihat Absen</a></td></tr>";
                        }
					...
					<div class="row  col-6 mx-auto">
	  					...
	  					<div  class="col-12">
							<a class='btn btn-primary mt-2 w-100' href='edit.php?<?php echo "ID_KELAS=$ID_KELAS&ID_MAPEL=$ID_MAPEL&JENIS=$JENIS&CRUD=1" ?>'>Edit Absen</a>
						</div>
					</div>
